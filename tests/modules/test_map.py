...
regular_lead = bytearray(b"\xe3\xbc\xb1\x149\xe9\xca\xb7\xbc\xff\xff\xff\xff\xff\xff\xff\xff\xff\x02\x02\xca\xd9\xe8\xd9\xff\xff\xff\x00\xe6\x81\x00\x00\xc4T{\xa3\xdaE{\xa3\xda&{\xa3\xdaU{\xa3\xdaU{\xa3\xdaU{\xa3\xa8J\xfd\xb27\x0f\x83\x8d\xdaU{\xa3\xfbU+\xa2\xc6UW\xa3\xf9}t\xba\x00\x00\x00\x00\x10\xff\'\x00\'\x00\x1a\x00\x13\x00\x10\x00\x11\x00\x13\x00")
magnet_pull = bytearray(b'Z\xae\xad\xf09\xe9\xca\xb7\xc7\xbb\xc1\xc8\xbf\xc7\xc3\xce\xbf\xff\x02\x02\xca\xd9\xe8\xd9\xff\xff\xff\x00\xd6\t\x00\x002GgGcqgGc\x08gGcGgGcGgGcGgG7GWGRG1G}SsS\x11y\xffVA\xa8{[cGgG\x00\x00\x00\x00\x18\xff$\x00.\x00\x1d\x00-\x00\x1c\x002\x00"\x00')
static = bytearray(b'"p\xd7.9\xe9\xca\xb7\xca\xc3\xc5\xbb\xbd\xc2\xcf\xff%\x00\x02\x02\xca\xd9\xe8\xd9\xff\xff\xff\x00\xc9a\x00\x00\x02\x99\x1d\x99\x12\xa4\x1d\x99\x1b\xdc\x1d\x99\x1b\x99\x1d\x99\x1b\x99\x1d\x99\x1b\x99\x1d\x99M\x99\x7f\x99s\x99\x08\x99\x0f\x87\x12\x8di\xa0\x84\xb0R\xb8\xe6\xbe\x1b\x99\x1d\x99\x00\x00\x00\x00\x19\xff6\x006\x00#\x00\x18\x001\x00%\x00\x1d\x00')
pressure = bytearray(b'=\x05\xce[9\xe9\xca\xb7\xbe\xcf\xcd\xbd\xc6\xc9\xca\xcd\xff\x00\x02\x02\xca\xd9\xe8\xd9\xff\xff\xff\x00\x00a\x00\x00\x04\xad\x9a\xf5\n\x00\xb2\xc7\x04\xec\x04\xecA\xed2\xedi\xec\xe0\xec\x10\xe3\x0e\xf8\x04\xec\x04\xec\x04\xec\x04\xec\x04\xec\x04\xecn\xed\x04\xecNr\x04\xec\x04\xc4\x04\xec\x00\x00\x00\x00%\xffQ\x00Q\x008\x00o\x00\x1e\x005\x00l\x00')
intimidate21 = bytearray(b"\x8b\xd2y\x8c9\xe9\xca\xb7\xc1\xd3\xbb\xcc\xbb\xbe\xc9\xcd\xff\x00\x02\x02\xca\xd9\xe8\xd9\xff\xff\xff\x00P}\x00\x00\xf3\x18\'*\x80W\x03\x01\xb2;\xb3;0;\xb3;\x8a\x16\xb3;\xb2k\xb3;\xb2;\xb3;\xb2;\xb3;\xb2;\xb3;$;\x92;\xb2;\xb3;\x9a\x18\xb3;\x00\x00\x00\x00\x15\xffJ\x00J\x003\x00+\x00\'\x00 \x00:\x00")
...
class TestEffectiveEncounterRatesForCurrentMap(unittest.TestCase):
    ...
    # assertEffectiveEncountersEqual checks that every effective encounter in
    # `first` is also present in `seond`, comparing species name, levels, and
    # encounter rate.  This is used instead of assertCountEqual because it
    # asserts exact equality between elements, which means floating point
    # rounding can cause an otherwise sound test to fail.
    def assertEffectiveEncountersEqual(self, first: list[modules.map.EffectiveWildEncounter], second: list[modules.map.EffectiveWildEncounter]):
        for encounter in first:
            ...
            for m in second:
                ...
                found = True
                self.assertEqual(encounter.min_level, m.min_level, msg=f'minimum levels do not match for species {encounter.species.name}')
                self.assertEqual(encounter.max_level, m.max_level, msg=f'maximum levels do not match for species {encounter.species.name}')
                self.assertAlmostEqual(encounter.encounter_rate, m.encounter_rate, msg=f'encounter rates do not match for species {encounter.species.name}')
    ...
    # Plusle for testing compex static and repel interactions
